...
import { FileText, CheckCircle2, Calendar, ChevronDown, Users } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-xl font-semibold text-gray-900">Exam Progress Tracker</h3>
                    ...
                    {months.map((month) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                          selectedMonth === month ? "bg-purple-50 text-purple-700 font-medium" : "text-gray-700"
                        }`}
                      >
                        {month}
                      </button>
            ...
            <div className="flex justify-center gap-8 mt-8">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">Completed <strong></strong></span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-full bg-purple-400" />
                <span className="text-sm text-gray-600">In Progress <strong></strong></span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-full bg-gray-800" />
                <span className="text-sm text-gray-600">Not Started <strong></strong></span>
              </div>
            </div>
          </div>
